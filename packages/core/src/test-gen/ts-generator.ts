...
/** @internal */
export function buildFunctionTest(
...
/** @internal */
export function buildClassTest(
  className: string,
...
/** @internal */
export function inferTestCases(fn: FunctionSignature): TestCase[] {
...
export function inferMockValue(name: string, type: string | null): string {
...
/** @internal */
export function inferReturnTypeCheck(returnType: string): string | null {
