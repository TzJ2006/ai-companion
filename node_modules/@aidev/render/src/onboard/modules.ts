...
export function renderModules(modules: ParsedModule[], reportData?: ReportData): string {
...
export function renderFunctionCard(fn: FunctionSignature, reasonData?: FunctionReasonData): string {
...
export function renderClassCard(cls: ClassInfo, filePath: string, reasonMap: Map<string, FunctionReasonData>): string {
