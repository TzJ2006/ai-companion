...
export declare function toChangeRecords(annotations: AnnotatedChange[], sessionId: string, eclContext?: EclContext): ChangeRecord[];
export declare function deduplicateByFunction(annotations: AnnotatedChange[]): AnnotatedChange[];
/** @internal */
export declare function extractNewContent(hunks: DiffHunk[]): string;
