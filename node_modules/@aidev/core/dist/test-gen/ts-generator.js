...
/** @internal */
export function buildFunctionTest(fn, sourceFile, config) {
...
/** @internal */
export function buildClassTest(className, methods, sourceFile, config) {
    const importPath = sourceFile.replace(/\\/g, "/").replace(/\.ts$/, ".js");
    const lines = [];
    const fw = config.test_framework;
...
/** @internal */
export function inferTestCases(fn) {
    const cases = [];
...
export function inferMockValue(name, type) {
    if (!type)
...
/** @internal */
export function inferReturnTypeCheck(returnType) {
...
/** @internal */
export function buildTestPath(sourceFile, name, _className, config) {
