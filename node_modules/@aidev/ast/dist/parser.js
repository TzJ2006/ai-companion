...
function parsePythonModule(rootNode, filePath) {
    const functions = [];
    const classes = [];
    const imports = [];
...
export function extractFunction(node, className) {
...
export function extractClass(node) {
    const nameNode = node.childForFieldName("name");
    const bodyNode = node.childForFieldName("body");
...
export function handleDecorated(node, functions, classes, className) {
...
export function extractFromImport(node) {
