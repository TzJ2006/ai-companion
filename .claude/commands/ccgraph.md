...
Read `D:/GitHub/ai-companion/claude-companion/FORMAT.md` if you need the node format.
...
With an id, instead: `npx tsx D:/GitHub/ai-companion/claude-companion/ideas.ts show <id>`.
